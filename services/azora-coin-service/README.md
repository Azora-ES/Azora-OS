# Azora Coin Service Service

**Constitutional AI Compliant Microservice**

## Overview
Azora Coin Service is a core microservice in the Azora OS ecosystem, built with Constitutional AI principles at its foundation.
