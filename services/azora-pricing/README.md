# Azora Pricing Service

**Constitutional AI Compliant Microservice**

## Overview
Azora Pricing is a core microservice in the Azora OS ecosystem, built with Constitutional AI principles at its foundation.
