# Ai Evolution Engine Service

**Constitutional AI Compliant Microservice**

## Overview
Ai Evolution Engine is a core microservice in the Azora OS ecosystem, built with Constitutional AI principles at its foundation.
...
### Service Endpoint
```
GET /api/v1/ai-evolution-engine
```
