# Azora Institutional System Service

**Constitutional AI Compliant Microservice**

## Overview
Azora Institutional System is a core microservice in the Azora OS ecosystem, built with Constitutional AI principles at its foundation.
...
### Service Endpoint
```
GET /api/v1/azora-institutional-system
```
